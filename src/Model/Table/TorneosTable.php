 ...
 * @method \App\Model\Entity\Torneo|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class TorneosTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator->dateTime('fecha_inicio')
            ->requirePresence('fecha_inicio', 'create')
            ->notEmpty('fecha_inicio');
        
        $validator->dateTime('fecha_fin')->allowEmpty('fecha_fin');
        
        $validator->requirePresence('active', 'create')->notEmpty('active');
